...
class RotatingFileStream extends stream_1.Writable {
    ...
    init(callback) {
        var _this$options = this.options,
            immutable = _this$options.immutable,
            initialRotation = _this$options.initialRotation,
    ...
    findName(tmp, callback, index) {
        ...
        var _this$options = this.options,
            ...
            intervalBoundary = _this$options.intervalBoundary;
    ...
    intervalBoundsBig(now) {
        ...
        var _this$options$interva = this.options.interval,
            num = _this$options$interva.num,
            unit = _this$options$interva.unit;
